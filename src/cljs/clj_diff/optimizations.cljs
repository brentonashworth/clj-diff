...
(defn- fast-common-prefix [^String a ^String b]
...
(defn- fast-common-suffix [^String a ^String b]
  (let [la (.-length a)
        lb (.-length b)
        n (min la lb)]
    (loop [i 1]
...
(defn- half-match* [^String long ^String short i]
